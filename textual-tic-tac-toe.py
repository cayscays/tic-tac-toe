...
class Board:
    ...
    def update_col_row(self, player_symbol, col, row):
        col = int(col)
        row = int(row)
        self.cells[row % self.board_size][
            col % self.board_size] = player_symbol  # the modulo is to prevent access to an out of range index
...
print('''Welcome to cayscays's Tic Tac Toe game!
    ''' + PLAYERS_MESSAGE + '\n')
